...
const objLat = (obj) => {
    ...
    let lN = obj.lastName;
    let nameWhitCap1 = fN.charAt(0);
    let nameWhitCap2 = lN.charAt(0);
    let fN1 = fN.slice(1);
    let lN2 = lN.slice(1);


    return `my name is ${nameWhitCap1}${fN1} ${nameWhitCap2}${lN2} I am ${obj.age} YO, and I love ${obj.hobby}.`
...
// ------------------------
// cvs.length
const cvFormatter = (cvs) => {

    for (let i = 0; i <= cvs.length; i++) {
        // Object.values(i).forEach( val => console.log(val));
        // const keys = Object.keys(cvs[i]);
        // console.log(keys)

        const value = Object.values(cvs[i]);
        // console.log(value);
        let fullName
